...
from openhands.agenthub.readonly_agent.tools.file_cache import FileCache
...
class UltimateReadOnlyAgent(CodeActAgent):
    ...
    def _get_tools(self) -> list["ChatCompletionToolParam"]:
        ...
        try:
            from openhands.agenthub.readonly_agent.tools.ultimate_explorer import (
        ...
        # Add Semantic Search
        try:
            from openhands.agenthub.readonly_agent.tools.semantic_search import (
