...
class RealTimeMonitor:
    ...
    def get_current_metrics(self, prompt_id: str = None) -> Dict[str, Any]:
    ...
    def get_performance_trends(self, prompt_id: str = None) -> Dict[str, Any]:
    ...
    def get_active_alerts(self, prompt_id: str = None) -> List[MonitoringAlert]:
    ...
    def clear_all_alerts(self, prompt_id: str = None) -> int:
