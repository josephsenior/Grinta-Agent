...
prompt_opt_storage_path = "~/.openhands/prompt_optimization/tools/"
...
```
~/.openhands/prompt_optimization/tools/
...
```python
import logging
logging.getLogger('openhands.prompt_optimization').setLevel(logging.DEBUG)
```
