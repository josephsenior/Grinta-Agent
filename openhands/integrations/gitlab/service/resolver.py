...
class GitLabResolverMixin(GitLabMixinBase):
    ...
    async def get_review_thread_comments(self, project_id: str, issue_iid: int, discussion_id: str) -> list[Comment]:
        url = f"{self.BASE_URL}/projects/{project_id}/merge_requests/{issue_iid}/discussions/{discussion_id}"
