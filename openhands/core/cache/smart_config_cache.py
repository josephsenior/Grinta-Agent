"""
🚀 HYBRID REDIS CACHING FOR SETTINGS API
==========================================

This module implements intelligent caching that separates:
...
class SmartConfigCache:
    ...
    def get_global_config(self) -> OpenHandsConfig | None:
    ...
    def _get_global_config_redis(self) -> OpenHandsConfig | None:
