...
def get_cli_parser() -> argparse.ArgumentParser:
    ...
    serve_parser = subparsers.add_parser("serve", help="Launch the OpenHands GUI server using Docker (web interface)")
    ...
    cli_parser = subparsers.add_parser("cli", help="Run OpenHands in CLI mode (terminal interface)")
