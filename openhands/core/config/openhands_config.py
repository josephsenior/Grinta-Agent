...
class OpenHandsConfig(BaseModel):
    ...
    # Removed: search_api_key (Tavily deprecated in favor of DuckDuckGo MCP)
    ...
    git_user_name: str = Field(default="openhands", description="Git user name for commits made by the agent")
