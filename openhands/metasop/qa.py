...
BASE_STATE_DIR = Path.home() / ".openhands" / "metasop_state"
...
def shape_failure_report(stdout: str, stderr: str) -> dict[str, Any]:
    return {"failures": 1 if "FAILED" in stdout or stderr else 0, "summary": (stdout + "\n" + stderr)[-4000:]}
