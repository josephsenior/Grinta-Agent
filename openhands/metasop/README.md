...
MetaGPT-inspired orchestration layer for OpenHands. Provides:
...
- Adapter to run steps via OpenHands agents
...
openhands/metasop/
  ...
  adapters/
    openhands.py    # Adapter stub for OpenHands agent execution
...
- This is an MVP. The adapter must be wired to the real OpenHands agent runner.
