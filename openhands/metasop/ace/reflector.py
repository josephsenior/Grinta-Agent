...
class ACEReflector:
    """
    Analyzes performance and extracts insights from execution results
...
"""
    ...
    def analyze(self, trajectory: ACETrajectory, execution_result: ACEExecutionResult,
                ground_truth: Optional[Any] = None, used_bullet_ids: List[str] = None,
                task_type: str = 'general', role: str = None, max_iterations: int = 5) -> ACEReflectionResult:
        """
    ...
    def _perform_reflection_iteration(self, trajectory: ACETrajectory, 
                                    execution_result: ACEExecutionResult,
                                    ground_truth: Optional[Any],
                                    playbook_content: str,
                                    task_type: str, role: str, iteration: int) -> Optional[ACEInsight]:
        ...
        try:
            ...
            try:
                ...
                if json_start >= 0 and json_end > json_start:
                    reflection_data = json.loads(response[json_start:json_end])
                else:
