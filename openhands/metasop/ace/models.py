...
class ACEDeltaUpdate(BaseModel):
    ...
    section: Optional[BulletSection] = Field(description="Section for the update")
    content: Optional[str] = Field(description="Content for the bullet")
    bullet_id: Optional[str] = Field(description="ID of bullet to update")
    tags: List[str] = Field(default_factory=list, description="Tags for the bullet")
    helpful: Optional[bool] = Field(description="Whether the bullet was helpful")
    harmful: Optional[bool] = Field(description="Whether the bullet was harmful")
...
class ACEConfig(BaseModel):
    ...
    playbook_persistence_path: Optional[str] = Field(description="Path for playbook persistence")
