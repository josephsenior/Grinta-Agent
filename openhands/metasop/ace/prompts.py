...
class ACEPromptManager:
    """
    Manages prompt templates for ACE components
    Adapts prompts from the research paper for OpenHands context
    """
...
"""
    ...
    def get_reflector_prompt(self, task_type: str, trajectory: str, 
                           ...
                           ground_truth: str = None, test_report: str = None,
                           role: str = None, task: str = None, 
                           expected_outcome: str = None) -> str:
    ...
    def get_curator_prompt(self, task_type: str, current_playbook: str,
                          ...
                          question_context: str = None, role: str = None,
                          task: str = None, expected_outcome: str = None) -> str:
