...
class AutonomyController:
    ...
    def __init__(self, config: AgentConfig) -> None:
        ...
        self.auto_retry = config.auto_retry_on_error
        self.max_iterations = config.max_autonomous_iterations
        self.stuck_detection = config.stuck_detection_enabled
        self.stuck_threshold = config.stuck_threshold_iterations
