...
OpenHands' LLM system provides a robust, provider-agnostic abstraction layer supporting **200+ models** from **30+ providers** via LiteLLM.
...
Edit `openhands/core/config/provider_config.py`:
...
tail -f logs/openhands.log | grep "Accumulated Cost"
