...
from openhands.server.middleware.compression import CompressionMiddleware
...
from openhands.server.routes.analytics import app as analytics_router
from openhands.server.routes.conversation import app as conversation_api_router
from openhands.server.routes.database_connections import (
...
from openhands.server.routes.global_export import app as global_export_router
from openhands.server.routes.health import add_health_endpoints
from openhands.server.routes.knowledge_base import router as knowledge_base_router
from openhands.server.routes.manage_conversations import (
    app as manage_conversation_api_router,
)
# Delay MCP import to avoid circular dependency issues during config loading
# from openhands.server.routes.mcp import mcp_server
from openhands.server.routes.memory import app as memory_router
from openhands.server.routes.metasop import app as metasop_router
from openhands.server.routes.monitoring import app as monitoring_router
from openhands.server.routes.prompts import app as prompts_router
from openhands.server.routes.prompt_optimization import router as prompt_optimization_router
from openhands.server.routes.public import app as public_api_router
from openhands.server.routes.secrets import app as secrets_router
from openhands.server.routes.security import app as security_api_router
from openhands.server.routes.settings import app as settings_router
from openhands.server.routes.slack import app as slack_router
from openhands.server.routes.snippets import app as snippets_router
from openhands.server.routes.templates import app as templates_router
...
from openhands.server.middleware.request_tracing import RequestTracingMiddleware
...
from openhands.server.versioning import version_middleware
...
# 3. CSRF protection
# 🔒 SECURITY: Enabled by default (can disable with env var for testing)
...
async def authentication_error_handler(request: Request, exc: AuthenticationError):
    ...
    """
    from openhands.server.utils.error_formatter import format_authentication_error
...
async def llm_no_response_handler(request: Request, exc: LLMNoResponseError):
    ...
    from openhands.server.utils.error_formatter import format_error_for_user
...
async def generic_exception_handler(request: Request, exc: Exception):
    ...
    """
    from openhands.server.utils.error_formatter import safe_format_error
...
app.include_router(slack_router, tags=["v1", "integrations"])
