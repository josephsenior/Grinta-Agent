...
app = APIRouter(prefix="/api/analytics")
...
async def get_prompt_optimization_analytics(
    ...
    try:
        # Try to get prompt optimization data from any active session
        # This is a simplified approach - in production you'd want to aggregate across all sessions
        session_manager = SessionManager()
        active_sessions = session_manager.get_active_sessions()
        
        prompt_optimization_data = {
            "enabled": False,
            "total_prompts": 0,
            "optimized_prompts": 0,
            "total_variants": 0,
        ...
        # Check if any session has prompt optimization enabled
