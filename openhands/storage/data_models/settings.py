...
class Settings(BaseModel):
    ...
    def _check_explicit_llm_config(app_config) -> bool:
        ...
        try:
            ...
            env_key = os.environ.get("OPENHANDS_API_KEY")
    ...
    def from_config() -> Settings | None:
        ...
        """
        import time
        global _settings_from_config_cache, _settings_from_config_cache_time
        
        current_time = time.time()
        
        # 🚀 FIX: Check module-level cache first
        if _settings_from_config_cache is not None:
            if current_time - _settings_from_config_cache_time < _SETTINGS_FROM_CONFIG_CACHE_TTL:
