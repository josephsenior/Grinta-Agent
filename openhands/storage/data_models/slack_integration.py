...
class SlackOAuthState(BaseModel):
    ...
    user_id: str = Field(..., description="OpenHands user ID")
    created_at: datetime = Field(default_factory=datetime.utcnow)
