...
class PlaybookContentResponse(BaseModel):
    ...
    `PlaybookContentResponse` aliases where appropriate.
    """
...
# Backwards-compatibility aliases for the refactor from "playbook" -> "playbook".
# These ensure imports referencing the old names keep working during the transition.
PlaybookMetadata = PlaybookMetadata
PlaybookResponse = PlaybookResponse
PlaybookContentResponse = PlaybookContentResponse
