...
from backend.server.types import AppMode, LLMAuthenticationError, MissingSettingsError
...
async def initialize_conversation(
    ...
    try:
        ...
        logger.warning(f"Failed to get conversation metadata for {conversation_id}: {e}")
    return None
