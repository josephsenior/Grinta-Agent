...
from backend.runtime import RuntimeAcquireResult, get_runtime_cls
...
async def create_runtime(
    *,
    ...
    session_logger.debug(
        f"Initializing runtime `{runtime_name}` now...",
...
async def _create_direct(
    *,
    ...
    try:
        ...
        session_logger.exception(f"Runtime initialization failed: {e}")
        if status_callback:
            status_callback(
