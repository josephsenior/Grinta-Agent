...
class CreateCollectionRequest(BaseModel):
    ...
    name: str = Field(..., min_length=1, max_length=KNOWLEDGE_BASE_NAME_MAX_LENGTH, description="Collection name")
    description: str | None = Field(None, max_length=KNOWLEDGE_BASE_DESCRIPTION_MAX_LENGTH, description="Collection description")
...
class SearchRequest(BaseModel):
    ...
    top_k: int = Field(default=KNOWLEDGE_BASE_SEARCH_TOP_K_DEFAULT, ge=1, le=KNOWLEDGE_BASE_SEARCH_TOP_K_MAX, description="Number of top results to return")
    relevance_threshold: float = Field(default=KNOWLEDGE_BASE_RELEVANCE_THRESHOLD_DEFAULT, ge=0.0, le=1.0, description="Minimum relevance score (0.0-1.0)")
