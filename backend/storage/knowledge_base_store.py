...
if TYPE_CHECKING:
    from backend.storage.knowledge_base.database_store_adapter import DatabaseStoreAdapter
...
def get_knowledge_base_store() -> KnowledgeBaseStore | Any:
    ...
    if _store is None:
        ...
        if storage_type in ("database", "db"):
            ...
            from backend.storage.knowledge_base.database_store_adapter import (
