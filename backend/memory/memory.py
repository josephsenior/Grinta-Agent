...
GLOBAL_PLAYBOOKS_DIR = os.path.join(
    os.path.dirname(backend.__file__), "playbooks"
)
...
class Memory:
    ...
    def load_user_workspace_playbooks(
        self, user_playbooks: list[BasePlaybook]
    ) -> None:
    ...
    def _load_global_playbooks(self) -> None:
        ...
        repo_agents, knowledge_agents = load_playbooks_from_dir(
