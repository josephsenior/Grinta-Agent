...
class GraphMemoryStore:
    ...
    def get_neighbors(self, node_id: str, edge_type: Optional[EdgeType] = None) -> List[dict]:
    ...
    def save(self):
        ...
        try:
            ...
            logger.debug(f"Graph saved to {self.persistence_path}")
    ...
    def load(self):
        ...
        try:
            ...
            logger.info(f"Graph loaded from {self.persistence_path} ({self.graph.number_of_nodes()} nodes)")
        except Exception as e:
