...
class TestJsonOutput:
    def test_info(self, json_handler):
        ...
        assert output.get(LOG_JSON_LEVEL_KEY) == "INFO"
    ...
    def test_error(self, json_handler):
        ...
        output = json.loads(string_io.getvalue())
        assert output.get("message") == "Test message"
        assert output.get(LOG_JSON_LEVEL_KEY) == "ERROR"
    ...
    def test_extra_fields_from_adapter(self, json_handler):
        ...
        assert output.get("message") == "Test message"
        assert output.get(LOG_JSON_LEVEL_KEY) == "INFO"
        assert output.get("context_field") == "..val.."
        assert output.get("log_fied") == "..val.."
