            ...
            function=ChatCompletionToolParamFunctionChunk(
                ...
                parameters={
                    ...
                    "properties": {
                        "thought": {
                            "type": "string",
                            "description": "Original thought description",
                        }
                    },
                },
            ),
...
- param2:
  ...
  type: number"""
        ...
        assert (
            parsed["parameters"]["properties"]["param1"]["description"]
            == "This is parameter 1"
        )
...
- paramY:
  value: Example"""
    ...
    def test_get_tool_optimization_status(self):
        ...
        self.optimizer.get_optimization_status = Mock(
    ...
    def test_force_optimize_tool(self):
        ...
        self.optimizer.add_variant.assert_called_once()
        self.optimizer.force_switch_variant.assert_called_once_with(
            "tool_think", "variant-id-1"
        )
    ...
    def test_evolve_tool_flow(self, monkeypatch: pytest.MonkeyPatch):
        ...
        self.optimizer.get_candidates_for_evolution.return_value = [
            PromptVariant(prompt_id="tool_think")
        ]
...
class TestToolDescriptions:
    ...
    def test_get_all_optimized_descriptions(self):
        ...
        from forge.prompt_optimization.tool_descriptions import (
            get_all_optimized_descriptions,
        )
    ...
    def test_create_tool_variant_content(self):
        ...
        content = create_tool_variant_content(
            ...
            description="Test description",
            parameters={
                "thought": {"description": "Test thought parameter", "type": "string"}
            },
        )
