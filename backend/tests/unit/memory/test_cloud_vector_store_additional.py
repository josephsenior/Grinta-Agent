...
def chroma_and_sentence_stubs(monkeypatch):
    collection_store: dict[str, object] = {}
    ...
    chromadb.PersistentClient = PersistentClient  # type: ignore[attr-defined]
    ...
    config_module.Settings = Settings  # type: ignore[attr-defined]
...
def qdrant_stub(monkeypatch, chroma_and_sentence_stubs):
    ...
    models_module.VectorParams = VectorParams  # type: ignore[attr-defined]
    models_module.Distance = SimpleNamespace(COSINE=Distance.COSINE)  # type: ignore[attr-defined]
    models_module.MatchValue = MatchValue  # type: ignore[attr-defined]
    models_module.FieldCondition = FieldCondition  # type: ignore[attr-defined]
    models_module.Filter = Filter  # type: ignore[attr-defined]
    models_module.PointStruct = PointStruct  # type: ignore[attr-defined]

    qdrant_client_module = ModuleType("qdrant_client")
    qdrant_client_module.QdrantClient = lambda **kwargs: DummyClient()  # type: ignore[attr-defined]
