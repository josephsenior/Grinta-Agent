# Forge GitHub Issue Resolver 🙌

Need help resolving a GitHub issue but don't have the time to do it yourself? Let an AI agent help you out!

This tool allows you to use open-source AI agents based on [Forge](https://github.com/Forge/Forge)
...
6. Set up any [custom configurations required](https://docs.forge.dev/usage/how-to/github-action#custom-configurations)
...
Need help? Feel free to [open an issue](https://github.com/Forge/Forge/issues) or email us at [contact@forge.dev](mailto:contact@forge.dev).
...
```bash
python -m Forge.resolver.resolve_issue --selected-repo Forge/Forge --issue-number 100
```
...
```bash
poetry run python Forge/resolver/resolve_issue.py --selected-repo Forge/Forge --issue-number 100
```
...
Alternatively, you can [email us](mailto:contact@forge.dev) or join the Forge Slack workspace (see [the README](/README.md) for an invite link).
