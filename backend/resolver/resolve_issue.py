"""Command-line entry point for driving the issue resolver workflow."""

from __future__ import annotations

import asyncio

from backend.resolver.issue_resolver import IssueResolver


def main() -> None:
    """CLI entry point for resolving a single issue or PR via IssueResolver."""
    import argparse

    def int_or_none(value: str) -> int | None:
        """Return None when value equals 'none' (case-insensitive), else int(value)."""
