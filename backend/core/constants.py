...
# None means omit temperature from API calls and use each provider's default.
...
DEFAULT_AGENT_ACCEPTANCE_CRITERIA_TOOL_ENABLED = True
...
DEFAULT_TOOL_RESULT_PREVIEW_CHARS = int(os.getenv('APP_TOOL_RESULT_PREVIEW', '2000'))
...
DEFAULT_GOAL_CONTEXT_MAX_CHARS = 1_200
DEFAULT_EXECUTION_CONTRACT_MAX_CHARS = 2_000
DEFAULT_CONTEXT_HYDRATE_CANONICAL_FROM_JSON_STORES = True
DEFAULT_CONTEXT_DEDUPE_PROMPT_PROJECTIONS = True
DEFAULT_USER_GOAL_SECTION_MAX_CHARS = 1_500
