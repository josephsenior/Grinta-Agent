...
class ActionSchemaV1(EventSchemaV1):
    ...
    runnable: bool = Field(
        default=False,
        description="Whether action can be executed"
    )
    confirmation_state: Optional[str] = Field(
        default=None,
        description="Action confirmation status"
    )
    security_risk: Optional[int] = Field(
        default=None,
        ge=0,
        description="Security risk level for this action"
    )
...
class FileReadActionSchema(ActionSchemaV1):
    ...
    impl_source: Optional[str] = Field(
        default=None,
        description="Implementation source"
    )
    view_range: Optional[list[int]] = Field(
        default=None,
        description="View range for file reading"
    )
...
class FileEditActionSchema(ActionSchemaV1):
    ...
    command: Optional[str] = Field(
        default=None,
        description="Editing command (FILE_EDITOR mode)"
    )
    ...
    content: Optional[str] = Field(
        default=None,
        description="Content to write (LLM-based editing)"
    )
    start: int = Field(
        default=1,
        ge=1,
...
class CmdRunActionSchema(ActionSchemaV1):
    ...
    is_input: bool = Field(
        default=False,
        description="Whether command is user input (for stdin)"
    )
    blocking: bool = Field(
        default=False,
    ...
    is_static: bool = Field(
        default=False,
        description="Whether command is static (from static analysis)"
    )
    ...
    hidden: bool = Field(
        default=False,
        description="Whether to hide command from user"
    )
...
class BrowseInteractiveActionSchema(ActionSchemaV1):
    ...
    browsergym_send_msg_to_user: Optional[str] = Field(
        default=None,
        description="Message to display to user"
    )
    return_axtree: bool = Field(
        default=False,
        description="Whether to return accessibility tree"
    )
