...
from backend.runtime import RuntimeOrchestrator, RuntimeAcquireResult, get_runtime_cls
...
def _add_github_token(provider_tokens: dict) -> None:
    ...
    if "GITHUB_TOKEN" in os.environ:
        from backend.integrations.provider import ProviderToken, ProviderType
