...
from forge.core.schemas.actions import ActionSchemaUnion
from forge.core.schemas.base import BaseEventSchema, EventVersion
from forge.core.schemas.observations import ObservationSchemaUnion
...
def deserialize_event(
    data: str | dict[str, Any], version: Optional[EventVersion] = None
) -> BaseEventSchema:
