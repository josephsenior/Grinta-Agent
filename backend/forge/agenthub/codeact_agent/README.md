...
**File:** `Forge/agenthub/codeact_agent/prompts.py`
...
tail -f logs/Forge.log | grep "CodeActAgent"
...
```python
# Forge/agenthub/codeact_agent/tools.py
...
```python
# Forge/agenthub/codeact_agent/prompts.py
