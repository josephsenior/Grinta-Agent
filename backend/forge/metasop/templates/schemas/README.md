...
```python
from forge.metasop.schema_validator import validate_artifact
...
```python
from forge.metasop.SCHEMA_INTEGRATION_EXAMPLE import EnhancedMetaSOPEventEmitter
...
```python
from forge.metasop.schema_validator import (
    validate_artifact,
