...
def launch_gui_server(mount_cwd: bool = False, gpu: bool = False) -> None:
    """Launch the Forge GUI server using Docker.
    ...
    """
    print_formatted_text(HTML("<ansiblue>🚀 Launching Forge GUI server...</ansiblue>"))
    print_formatted_text("")
    ...
    app_image = f"docker.all-hands.dev/all-hands-ai/Forge:{version}"
