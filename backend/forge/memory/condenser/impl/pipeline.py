...
if TYPE_CHECKING:
    from forge.core.config.condenser_config import CondenserPipelineConfig
...
class CondenserPipeline(Condenser):
    ...
    def __init__(self, *condenser: Condenser) -> None:
        ...
        Example:
            >>> from forge.memory.condenser.impl import RecentEventsCondenser, LLMSummarizingCondenser
...
def _register_config():
    ...
    Side Effects:
        - Imports CondenserPipelineConfig from forge.core.config.condenser_config
