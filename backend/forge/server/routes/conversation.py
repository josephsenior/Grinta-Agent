...
from forge.server.user_auth import get_user_id, get_user_settings_store
...
from forge.controller.circuit_breaker import CircuitBreaker, CircuitBreakerConfig, CircuitBreakerResult
from forge.events.action import ActionSecurityRisk
from forge.core.cache.async_smart_cache import AsyncSmartCache
from forge.llm.cost_tracker import record_llm_cost_from_response
import asyncio
...
async def get_code_completion(
    ...
    # Timeout for code completion (30 seconds max)
