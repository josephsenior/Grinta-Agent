...
from forge.core.exceptions import ResourceLimitExceededError
...
class ResourceLimits:
    ...
    max_disk_gb: int = 10  # 10GB default
    max_file_count: int = 10000  # 10k files
    ...
    def __init__(
        ...
        if limits is None:
            limits = ResourceLimits(
                max_memory_mb=int(os.getenv("RUNTIME_MAX_MEMORY_MB", "2048")),
                max_cpu_percent=float(os.getenv("RUNTIME_MAX_CPU_PERCENT", "80.0")),
                max_disk_gb=int(os.getenv("RUNTIME_MAX_DISK_GB", "10")),
                max_file_count=int(os.getenv("RUNTIME_MAX_FILE_COUNT", "10000")),
            )
