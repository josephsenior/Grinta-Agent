...
from forge.runtime.utils.prompt_detector import detect_interactive_prompt
...
class BashSession:
    ...
    def initialize(self) -> None:
        ...
        self.pane = pane
        logger.debug(
            "pane: %s; history_limit: %s", pane, session.history_limit
        )
        pane.send_keys(
    ...
    def _monitor_command_execution(
        ...
        while should_continue():
            ...
            if cur_pane_output != last_pane_output:
                ...
                from forge.runtime.utils.server_detector import (
                    detect_server_from_output,
                )

                detected_server = detect_server_from_output(
                    cur_pane_output, perform_health_check=True
                )
