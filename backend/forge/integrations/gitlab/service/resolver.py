# pragma: no cover
"""GitLab mixin providing helper queries for the resolver workflow."""
...
try:
    from forge.integrations.gitlab.service.client import GitlabClient  # type: ignore[attr-defined]
except Exception:  # pragma: no cover - optional dependency
    GitlabClient = Any  # type: ignore

try:
    from forge.integrations.gitlab.service.types import ReviewThreadComment  # type: ignore[attr-defined]
except Exception:  # pragma: no cover - optional dependency
    ReviewThreadComment = dict[str, Any]
