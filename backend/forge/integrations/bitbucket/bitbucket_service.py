"""Bitbucket service mixin wiring and default implementation for Forge."""
...
from forge.integrations.bitbucket.service import (
...
class BitBucketService(
    ...
    This is an extension point in Forge that allows applications to customize Bitbucket
    ...
    def __init__(
        ...
        """Initialize the Bitbucket service with authentication context."""
    ...
    def provider(self) -> str:
        """Return provider identifier for this Bitbucket service implementation."""
        return ProviderType.BITBUCKET.value


bitbucket_service_cls = os.environ.get(
    "FORGE_BITBUCKET_SERVICE_CLS",
    "forge.integrations.bitbucket.bitbucket_service.BitBucketService",
)
