"""State tracker utilities for coordinating agent execution lifecycle."""
...
# this cap prevents unbounded memory growth during long sessions.
# Events beyond this limit are trimmed from the front (oldest first).
...
# regardless of the count cap.  Prevents pathological cases where a
# small number of very large events (huge command output, file contents)
# consume hundreds of MB.
