...
from backend.events.action import Action, ActionConfirmationStatus

if TYPE_CHECKING:
    from backend.controller.services.controller_context import ControllerContext
    from backend.controller.services.safety_service import SafetyService
...
class ConfirmationService:
    ...
    async def handle_observation_for_pending_action(
        ...
        # Run pipeline observe stage if context available
