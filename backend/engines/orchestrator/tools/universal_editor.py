...
from typing import Any, Callable, Dict, Optional, Tuple, TYPE_CHECKING, cast
...
class UniversalEditor:
    ...
    **Other:**
    ...
    def get_parser(self, language: str) -> Optional[ParserType]:
    ...
    ) -> Optional[Tuple[TreeType, bytes, str]]:
    ...
    def _get_name_node(self, node: NodeType) -> Optional[NodeType]:
