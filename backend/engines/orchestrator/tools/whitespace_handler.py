...
class WhitespaceHandler:
    ...
    DEFAULT_INDENT_SIZES = DEFAULT_INDENT_SIZES
    ...
    def _determine_indent_style(
        ...
        return IndentStyle.SPACES, WhitespaceHandler.DEFAULT_INDENT_SIZES.get(
            language or "", 4
        )
    ...
    def clean_whitespace(
        code: str, config: Optional[IndentConfig] = None, language: Optional[str] = None
    ) -> str:
