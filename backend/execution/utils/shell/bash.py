...
from backend.execution.utils.shell._bash_command import execute as _execute
from backend.execution.utils.shell._bash_detached import (
...
from backend.execution.utils.shell._bash_pane import (
    _clear_screen,
...
from backend.execution.utils.shell._bash_server import (
    _detect_server_startup,
)
from backend.execution.utils.shell._bash_server import (
    get_detected_server as _get_detected_server,
)
from backend.execution.utils.shell._bash_timeouts import (
    _check_timeouts,
...
from backend.execution.utils.shell.bash_support import (  # noqa: F401
...
class BashSession(BaseShellSession):
    ...
    def initialize(self) -> None:
        ...
        try:
            session.set_option('history-limit', history_limit, _global=True)  # type: ignore[call-arg]
        except TypeError:
            try:
