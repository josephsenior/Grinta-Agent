"""Abstract interface for event store backends."""
...
class EventStoreABC:
    ...
    def get_events(
        ...
        """Deprecated: Get events (use search_events instead)."""
    ...
    def filtered_events_by_source(self, source: EventSource) -> Iterable[Event]:
        """Deprecated: Filter events by source (use search_events instead)."""
