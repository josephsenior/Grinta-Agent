...
async function handleRequest(method, params, handler) {
    try {
        ...
        return await circuitBreakers.external.execute(() => handler(validatedParams));
    }
    catch (error) {
...
export const setupHandlers = (server) => {
    ...
    server.setRequestHandler(ListResourceTemplatesRequestSchema, async (request) => {
        return await handleRequest('list_resource_templates', request.params, async () => ({
            resourceTemplates,
        }));
    });
    ...
    server.setRequestHandler(ListPromptsRequestSchema, async (request) => {
        return await handleRequest('list_prompts', request.params, async () => ({
    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        return await handleRequest('call_tool', request.params, async (validatedParams) => {
            ...
            return await circuitBreakers.external.execute(() => Promise.resolve(handler(params || {})));
        });
    });
