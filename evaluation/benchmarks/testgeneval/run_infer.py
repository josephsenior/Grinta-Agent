...
def process_instance(instance: pd.Series, metadata: EvalMetadata, reset_logger: bool = True) -> EvalOutput:
    ...
    if reset_logger:
        ...
        logger.info("Starting evaluation for instance %s.", instance.id)
    ...
    return EvalOutput(
        ...
        instance=_preprocess_instance(instance.to_dict()),
...
if __name__ == "__main__":
    ...
    logger.info("Loaded dataset %s with split %s", args.dataset, args.split)
