...
if __name__ == "__main__":
    lite1 = "all-swebench-lite-instance-images.txt"
    lite2 = "../../swe_bench/scripts/docker/all-swebench-lite-instance-images.txt"
    print_diff_ignore_order(lite1, lite2)
    full1 = "all-swebench-full-instance-images.txt"
    full2 = "../../swe_bench/scripts/docker/all-swebench-full-instance-images.txt"
