...
def get_changed_code(target_filepath, line_start, include_signature=False):
    ...
    with open("/testing_files/first_line_after_removed.txt", "r", encoding='utf-8') as f:
...
def copy_changed_code(target_filepath, generated_code_filepath, line_start, include_signature=False):
    ...
    with open(generated_code_filepath, "w", encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    copy_changed_code(args.target_filepath, args.generated_code_filepath, args.line_start, args.include_signature)
