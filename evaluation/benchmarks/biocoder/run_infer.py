...
def initialize_runtime(runtime: Runtime, instance: BiocoderData):
    ...
    action = CmdRunAction(command="chmod -R 755 /workspace")  # nosec B103
    logger.info(action, extra={"msg_type": "ACTION"})
    obs = runtime.run_action(action)
...
if __name__ == "__main__":
    ...
    dataset = load_dataset("lilbillbiscuit/biocoder_public")  # nosec B615 - Safe: evaluation benchmark dataset
