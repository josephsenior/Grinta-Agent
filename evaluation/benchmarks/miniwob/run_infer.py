...
def initialize_runtime(runtime: Runtime) -> tuple[str, BrowserOutputObservation]:
...
if __name__ == "__main__":
    ...
    metadata = make_metadata(
        llm_config, "miniwob", args.agent_cls, args.max_iterations, args.eval_note, args.eval_output_dir
    )
