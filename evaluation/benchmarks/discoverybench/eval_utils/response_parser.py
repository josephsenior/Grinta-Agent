workflow_summary_markers = ["WORKFLOW SUMMARY", "WORKFLOW_SUMMARY", "WORKFLOW-SUMMARY", "Workflow Summary"]
...
next_agent_markers = ["NEXT AGENT", "NEXT-AGENT", "NEXT_AGENT", "FEEDBACK"]
