"""Utilities for cleaning up conversation metadata stored on disk."""
...
from forge.storage.data_models.conversation_metadata_result_set import (
...
from forge.utils.search_utils import offset_to_page_id, page_id_to_offset
...
class FileConversationStore(ConversationStore):
    """Filesystem-based ConversationStore variant used during cleanup tasks."""
    ...
    def __init__(
        ...
        """Initialize the cleanup-focused conversation store wrapper."""
    ...
    async def get_instance(cls, config: ForgeConfig, user_id: str | None) -> FileConversationStore:
        """Get FileConversationStore singleton instance with cleanup scheduling.
