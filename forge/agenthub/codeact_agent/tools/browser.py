...
class BrowserTool:
    """Tool wrapper for interacting with the browser gym environment."""

    def __init__(self, action_set: HighLevelActionSet) -> None:
        """Create a browser tool bound to a high-level action set."""
