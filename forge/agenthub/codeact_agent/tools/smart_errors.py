...
class SmartErrorHandler:
    ...
    @staticmethod
    def _check_common_typo(symbol_name: str) -> Optional[ErrorSuggestion]:
    ...
    @staticmethod
    def _group_symbols_by_type(available_symbols: List[str]) -> tuple[List[str], List[str]]:
    ...
    @staticmethod
    def _analyze_invalid_syntax(error_lower: str, code_context: Optional[str]) -> tuple[List[str], float]:
