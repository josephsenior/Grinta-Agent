"""Load SOP templates, role profiles, and schemas for MetaSOP."""
...
def load_role_profiles() -> dict[str, RoleProfile]:
    """Load all builtin role profiles from YAML files."""
...
def load_sop_template(name: str) -> SopTemplate:
    """Load SOP template by name, raising with suggestions on failure."""
...
def load_schema(schema_name: str) -> dict:
    """Load JSON schema document referenced by SOP template."""
