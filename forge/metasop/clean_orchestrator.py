...
from forge.metasop.models import SopTemplate, SopStep, Artifact, StepResult
from forge.metasop.template_loader import get_default_template, load_template
...
class CleanMetaSOPOrchestrator:
    ...
    def set_emit_callback(self, callback: Optional[Callable[[Dict[str, Any]], None]]) -> None:
