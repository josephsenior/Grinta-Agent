...
This guide explains how to integrate the ACE Framework into your Forge application and customize it for your specific needs.
...
ace_playbook_persistence_path = "~/.Forge/ace_playbooks/metasop/"
```
...
enable_ace = true
ace_max_bullets = 1000
ace_playbook_path = "~/.Forge/ace_playbooks/codeact/"
```
...
```python
import logging
logging.getLogger("Forge.metasop.ace").setLevel(logging.DEBUG)
```
...
4. Open an issue on the Forge repository
