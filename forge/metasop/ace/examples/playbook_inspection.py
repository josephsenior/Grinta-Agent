...
def analyze_bullet_quality(playbook: ContextPlaybook):
    ...
    helpfulness_scores = [bullet.helpfulness_score for bullet in playbook.bullets.values()]
...
def show_top_strategies(playbook: ContextPlaybook, section: Optional[BulletSection] = None, limit: int = 10):
