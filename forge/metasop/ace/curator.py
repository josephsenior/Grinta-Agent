...
"""
    ...
    def curate(self, insights: List[ACEInsight], current_playbook: ContextPlaybook,
               ...
               role: Optional[str] = None, expected_outcome: Optional[str] = None) -> ACECurationResult:
        ...
        try:
            ...
            prompt = self._format_prompt_for_task_type(
                task_type, task_context, playbook_content, insights_text,
                insights, role, expected_outcome
            )
    ...
    def curate_batch(self, insights_batch: List[List[ACEInsight]], 
                    ...
                    task_types: Optional[List[str]] = None) -> List[ACECurationResult]:
