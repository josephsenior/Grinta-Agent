...
from forge.metasop.ace.context_playbook import ContextPlaybook, BulletPoint, BulletSection
...
class TestContextPlaybook:
    ...
    def _verify_export_structure(self, exported: dict, bullet1: str, bullet2: str) -> None:
    ...
    def _verify_import_result(self, new_playbook: ContextPlaybook, bullet1: str, bullet2: str) -> None:
