"""Security analyzer implementation backed by Invariant policy engine."""
...
from forge.security.invariant.parser import TraceElement, parse_element
...
class InvariantAnalyzer(SecurityAnalyzer):
    ...
    container_name: str = "Forge-invariant-server"
    image_name: str = "ghcr.io/invariantlabs-ai/server:Forge"
