"""Tests for the step cache fingerprinting logic."""
...
def test_get_by_fingerprint_hit_and_miss(tmp_path) -> None:
    """Store an entry then assert fingerprint lookup hits and misses behave as expected."""
...
def test_get_by_fingerprint_ttl_expiry(tmp_path) -> None:
    """Expired cache entries should be ignored even if fingerprints match."""
