"""Configuration models for Forge deployments on Kubernetes."""
...
class KubernetesConfig(BaseModel):
    ...
    Attributes:
        namespace: The Kubernetes namespace to use for Forge resources
    ...
    namespace: str = Field(default="default", description="The Kubernetes namespace to use for Forge resources")
    ...
    def from_toml_section(cls, data: dict) -> dict[str, KubernetesConfig]:
        ...
        try:
            ...
            msg = f"Invalid kubernetes configuration: {e}"
