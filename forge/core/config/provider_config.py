...
class ProviderConfigurationManager:
    ...
    def _process_base_url_param(self, param_value: Any, provider: str, cleaned_params: Dict[str, Any], config: ProviderConfig) -> None:
    ...
    def _process_known_param(self, param_name: str, param_value: Any, config: ProviderConfig, cleaned_params: Dict[str, Any]) -> None:
    ...
    def _process_unknown_param(self, param_name: str, param_value: Any, provider: str, cleaned_params: Dict[str, Any]) -> None:
