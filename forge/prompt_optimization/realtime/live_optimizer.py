...
class LiveOptimizer:
    ...
    def _get_variant_metrics(self, prompt_id: str, available_variants: list) -> dict:
    ...
    def _create_no_improvement_result(self, event_id: str, current_variant_id: str) -> LiveOptimizationResult:
    ...
    async def _perform_live_optimization(self, event: LiveOptimizationEvent) -> LiveOptimizationResult:
        ...
        try:
            ...
            metrics = self._get_variant_metrics(prompt_id, available_variants)
            ...
            if not best_variant or best_variant.id == current_variant.id:
                return self._create_no_improvement_result(event.event_id, current_variant.id)
    ...
    def get_optimization_history(self, prompt_id: Optional[str] = None) -> List[LiveOptimizationResult]:
