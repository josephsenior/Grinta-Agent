...
class PromptVariant:
    ...
    prompt_id: str = (
        ""  # Base prompt identifier (e.g., "engineer_role", "codeact_system")
    )
    ...
    def update_metrics(
        self, success: bool, execution_time: float, token_cost: float = 0.0
    ):
...
class OptimizationConfig:
    ...
    prompt_history_auto_flush: bool = False
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "prompt_history_auto_flush": self.prompt_history_auto_flush,
        }
