...
class AdvancedStrategyManager:
    ...
    def _calculate_objective_score(self, objective: str, strategy_name: str, weight: float) -> float:
    ...
    def _check_accuracy_constraint(self, strategy_name: str, min_accuracy: float) -> bool:
    ...
    def _satisfies_constraints(
        ...
        if 'max_memory' in constraints:
            if not self._check_memory_constraint(strategy_name, constraints['max_memory']):
                return False
        ...
        if 'min_accuracy' in constraints:
            if not self._check_accuracy_constraint(strategy_name, constraints['min_accuracy']):
                return False
