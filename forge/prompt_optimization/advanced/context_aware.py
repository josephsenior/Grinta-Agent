...
class ContextAwareOptimizer:
    ...
    def __init__(self):
        """Preload contextual strategies and initialize adaptation state tracking."""
            ...
            adaptation_rules=[
                {
                    ...
                    "action": "increase_technical_depth",
                },
            ...
            adaptation_rules=[
                {
                    ...
                    "action": "add_framework_examples",
                },
                {
                    "condition": "execution_time > 5",
                    "action": "simplify_code_structure",
                },
            ],
        )
    ...
    def analyze_context(self, context_data: Dict[str, Any]) -> OptimizationContext:
        ...
        domain = self._detect_domain(
            context_data.get("metadata", {}), context_data.get("content", "")
        )
        ...
        for strategy in self.context_strategies.values():
            for task_type, domain, exec_context in strategy.applicable_contexts:
                if (
                    ...
                    and context.execution_context == exec_context
                ):
    ...
    def _score_strategy_fit(
        self, strategy: ContextualStrategy, context: OptimizationContext
    ) -> float:
    ...
    def _create_fallback_strategy(
        ...
        return ContextualStrategy(
            ...
            applicable_contexts=[
                (context.task_type, context.domain, context.execution_context)
            ],
            optimization_weights={
                "performance": 0.4,
                "efficiency": 0.3,
    ...
    def _evaluate_condition(
        self, condition: str, performance_data: Dict[str, Any]
    ) -> bool:
    ...
    def _apply_action(
        self, action: str, strategy: ContextualStrategy, context: OptimizationContext
    ) -> None:
        ...
        if action == "increase_technical_depth":
            ...
            strategy.optimization_weights["innovation"] = (
                strategy.optimization_weights.get("innovation", 0) + 0.2
            )
