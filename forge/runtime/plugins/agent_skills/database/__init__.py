"""Database helper library for Forge agent sandbox.

This library provides database connection and query functions that execute
in the user's sandbox environment, ensuring credentials never leave their infrastructure.
...
async def connect_mongodb(env_prefix: str, connection_name: str) -> dict[str, Any]:
    ...
    """
    try:
        from motor.motor_asyncio import AsyncIOMotorClient  # type: ignore[import-not-found, import-untyped]
    except ImportError:
