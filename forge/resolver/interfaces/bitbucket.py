"""Bitbucket-specific implementations of resolver issue handlers."""
...
class BitbucketIssueHandler(IssueHandlerInterface):
    """Minimal Bitbucket implementation of IssueHandlerInterface."""
    ...
    def set_owner(self, owner: str) -> None:
        """Update handler to point at a different workspace/owner."""
        self.owner = owner
    ...
    def _fetch_issue_content(self, issue_number: int) -> str | None:
        ...
        try:
            ...
            return issue_data.get("content", {}).get("raw", "")
