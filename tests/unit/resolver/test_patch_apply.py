...
def test_patch_apply_with_empty_lines():
    ...
    patch = "diff --git a/README.md b/README.md\nindex b760a53..5071727 100644\n--- a/README.md\n+++ b/README.md\n@@ -1,3 +1,3 @@\n # PR Viewer\n\n-This React application allows you to view open pull requests from GitHub repositories in a GitHub organization. By default, it uses the All-Hands-AI organization.\n+This React application was created by Graham Neubig and forge. It allows you to view open pull requests from GitHub repositories in a GitHub organization. By default, it uses the All-Hands-AI organization."
