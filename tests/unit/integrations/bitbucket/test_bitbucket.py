...
async def test_validate_provider_token_with_bitbucket_token():
    ...
    """
    with patch("openhands.integrations.utils.GitHubService") as mock_github_service, patch(
        "openhands.integrations.utils.GitLabService"
    ) as mock_gitlab_service, patch("openhands.integrations.utils.BitBucketService") as mock_bitbucket_service:
