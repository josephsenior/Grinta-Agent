...
class DummyHTTPClient(HTTPClient):
    """Non-test-class helper implementing HTTPClient for unit tests.

    Named to avoid pytest collecting it as a test class (pytest treats any class
    starting with 'Test' that has an __init__ as a discovered test class and
    emits a collection warning).
    """
