...
def test_initialize_repository_for_runtime(temp_dir, runtime_cls, run_as_openhands):
    ...
    mock_repo = Repository(
        id="1232", full_name="All-Hands-AI/OpenHands", git_provider=ProviderType.GITHUB, is_public=True
    )
    with patch("openhands.runtime.base.ProviderHandler.verify_repo_provider", return_value=mock_repo):
