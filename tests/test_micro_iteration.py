...
@pytest.mark.skip(reason="Temporarily skipped pending stabilization of micro-iteration artifact validation path")
def test_micro_iteration_basic():
    ...
    assert any((e.get("no_change_stop") for e in micro_events)), "Expected a no_change_stop termination event"
