...
The following is intended as a primer on debugging Forge for Development purposes.
...
Values in the snippet above can be updated such that:
    ...
    * *t*: the task
    * *d*: the Forge workspace directory
    * *c*: the agent
