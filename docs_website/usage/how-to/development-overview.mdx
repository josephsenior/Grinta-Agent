...
description: This guide provides an overview of the key documentation resources available in the Forge repository. Whether you're looking to contribute, understand the architecture, or work on specific components, these resources will help you navigate the codebase effectively.
---
...
- **Main Project Overview** (`/README.md`)
  The primary entry point for understanding Forge, including features and basic setup instructions.

- **Development Guide** (`/Development.md`)
  Comprehensive guide for developers working on Forge, including setup, requirements, and development workflows.
...
If you're new to developing with Forge, we recommend following this sequence:
...
4. Dive into specific component documentation based on your area of interest:
   ...
   - Backend developers should start with `/Forge/README.md`
