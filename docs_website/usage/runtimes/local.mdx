---
title: Local Runtime
description: The Local Runtime allows the Forge agent to execute actions directly on your local machine without
...
1. You can run Forge using the [Development workflow](https://github.com/All-Hands-AI/Forge/blob/main/Development.md).
...
the following options via environment variables or the [config.toml file](https://github.com/All-Hands-AI/Forge/blob/main/config.template.toml) when starting Forge:
...
Here's an example of how to start Forge with the Local Runtime in Headless Mode:
...
- Testing and development of Forge itself.
