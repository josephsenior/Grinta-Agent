...
description: Overview of some of the settings available in Forge.
---

## Forge Cloud vs Running on Your Own

There are some differences between the settings available in Forge Cloud and those available when running Forge
on your own:
* [Forge Cloud settings](/usage/cloud/cloud-ui#settings)
...
Forge provides a secrets manager that allows you to securely store and manage sensitive information that can be
