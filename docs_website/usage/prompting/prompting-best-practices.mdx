...
description: When working with Forge AI software developer, providing clear and effective prompts is key to getting accurate and useful responses. This guide outlines best practices for crafting effective prompts.
---
...
The more precise and informative your prompt, the better Forge can assist you.

See [Getting Started with Forge](../getting-started) for more examples of helpful prompts.
