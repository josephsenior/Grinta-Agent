...
description: Global microagents are [keyword-triggered microagents](./microagents-keyword) that apply to all Forge users. A list of the current global microagents can be found [in the Forge repository](https://github.com/All-Hands-AI/Forge/tree/main/microagents).
---
...
See the [CONTRIBUTING.md](https://github.com/All-Hands-AI/Forge/blob/main/CONTRIBUTING.md) for specific instructions on how to contribute to Forge.
...
[`microagents/`](https://github.com/All-Hands-AI/Forge/tree/main/microagents)
