---
title: Moonshot AI
description: How to use Moonshot AI models with Forge
---

## Using Moonshot AI with Forge

[Moonshot AI](https://platform.moonshot.ai/) offers several powerful models, including Kimi-K2, which has been verified to work well with Forge.

### Setup

1. Sign up for an account at [Moonshot AI Platform](https://platform.moonshot.ai/)
2. Generate an API key from your account settings
3. Configure Forge to use Moonshot AI:
