---
title: OpenAI
description: Forge uses LiteLLM to make calls to OpenAI's chat models. You can find their documentation on using OpenAI as a provider [here](https://docs.litellm.ai/docs/providers/openai).
---
...
If you're using an OpenAI proxy, in the Forge UI through the Settings under the `LLM` tab:
