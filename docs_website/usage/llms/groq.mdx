---
title: Groq
description: Forge uses LiteLLM to make calls to chat models on Groq. You can find their documentation on using Groq as a provider [here](https://docs.litellm.ai/docs/providers/groq).
---
...
would access any OpenAI-compatible endpoint. In the Forge UI through the Settings under the `LLM` tab:
