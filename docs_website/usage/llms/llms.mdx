---
title: Overview
description: Forge can connect to any LLM supported by LiteLLM. However, it requires a powerful model to work.
---

<Note>
This section is for users who want to connect Forge to different LLMs.
</Note>
...
Based on these findings and community feedback, these are the latest models that have been verified to work reasonably well with Forge:
...
If you have successfully run Forge with specific providers, we encourage you to open a PR to share your setup process
...
<Warning>
Forge will issue many prompts to the LLM you configure. Most of these LLMs cost money, so be sure to set spending
...
- [all-hands/Forge-lm-32b-v0.1](https://www.all-hands.dev/blog/introducing-Forge-lm-32b----a-strong-open-coding-agent-model) (31 March 2025) -- also available through [OpenRouter](https://openrouter.ai/all-hands/Forge-lm-32b-v0.1)

### Known Issues

<Warning>
As of July 2025, there are known issues with Gemini 2.5 Pro conversations taking longer than normal with Forge. We are continuing to investigate.
</Warning>

<Note>
Most current local and open source models are not as powerful. When using such models, you may see long
wait times between messages, poor responses, or errors about malformed JSON. Forge can only be as powerful as the
models driving it. However, if you do find ones that work, please add them to the verified list above.
</Note>

## LLM Configuration

The following can be set in the Forge UI through the Settings:
...
We have a few guides for running Forge with specific model providers:
...
- [Forge](/usage/llms/Forge-llms)
- [OpenRouter](/usage/llms/openrouter)

## Model Customization

LLM providers have specific settings that can be customized to optimize their performance with Forge, such as:
...
LLM providers typically have rate limits, sometimes very low, and may require retries. Forge will automatically
...
If you are running Forge in development mode, you can also set these options in the `config.toml` file:
