...
When using Forge, you will encounter cases where things work well, and others where they don't. We encourage you to
provide feedback when you use Forge to help give feedback to the development team, and perhaps more importantly,
create an open corpus of coding agent training examples -- Share-Forge!

## 📝 How to Provide Feedback

Providing feedback is easy! When you are using Forge, you can press the thumbs-up or thumbs-down button at any point
...
- **Public** data will be distributed under the MIT License, like Forge itself, and can be used by the community to
...
- **Private** data will be made available to the Forge team for the purpose of improving Forge.
...
The data is collected and stored by [All Hands AI](https://all-hands.dev), a company founded by Forge maintainers to support and improve Forge.
