...
description: Complete guide for setting up Jira Data Center integration with Forge Cloud, including service account creation, personal access token generation, webhook configuration, and workspace integration setup.
---
...
2. **Create User**
   ...
   - Full Name: `Forge Agent`
   - Email: `Forge@yourcompany.com` (replace with your preferred service account email)
...
### Step 1: Log in to Forge Cloud

1. **Navigate and Authenticate**
   - Go to [Forge Cloud](https://app.all-hands.dev/)
   - Sign in with your Git provider (GitHub, GitLab, or BitBucket)
   - **Important:** Make sure you're signing in with the same Git provider account that contains the repositories you want the Forge agent to work on.
...
3. **Complete OAuth Flow**
   ...
   - If successful, you will be redirected back to the **Integrations** settings in the Forge Cloud UI
