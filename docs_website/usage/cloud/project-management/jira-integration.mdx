...
description: Complete guide for setting up Jira Cloud integration with Forge Cloud, including service account creation, API token generation, webhook configuration, and workspace integration setup.
---
...
2. **Create Forge Service Account**
