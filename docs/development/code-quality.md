...
```
Production Backend Code (Python):   109,626 lines
Production Frontend Code (TS/TSX): 82,329 lines
Total Production Code:              191,955 lines
Total Python Files:                 541 files
Total Frontend Files:               763 files (TypeScript/TSX)
Source Lines of Code (SLOC):        ~192,000 (production code, excluding tests)
Logical Lines of Code (LLOC):       ~150,000 (estimated)
