...
describe("Settings Billing", () => {
  ...
  it("should not render the credits tab if OSS mode", async () => {
    ...
    const navbar = settingsScreen.querySelector("nav");
    expect(navbar).not.toBeNull();
    const navbarEl = navbar as HTMLElement;
    const credits = within(navbarEl).queryByText("Credits");
  ...
  it("should render the credits tab if SaaS mode and billing is enabled", async () => {
    ...
    expect(navbar).not.toBeNull();
    const navbarEl = navbar as HTMLElement;
    within(navbarEl).getByText("Credits");
  });
  ...
  it("should render the billing settings if clicking the credits item", async () => {
    ...
    expect(navbar).not.toBeNull();
    const navbarEl = navbar as HTMLElement;
    const credits = within(navbarEl).getByText("Credits");
