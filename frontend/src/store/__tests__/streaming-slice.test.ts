...
describe("streamingSlice", () => {
  ...
  describe("startStream", () => {
    ...
    it("should reset existing stream if started again", () => {
      ...
      store.dispatch(appendStreamChunk({ streamId: "test-stream", chunk: "old content" }));
  ...
  describe("appendStreamChunk", () => {
    ...
    it("should append chunk to stream content", () => {
      store.dispatch(appendStreamChunk({ streamId: "test-stream", chunk: "Hello " }));
      store.dispatch(appendStreamChunk({ streamId: "test-stream", chunk: "World" }));
    ...
    it("should handle newlines and special characters", () => {
      store.dispatch(appendStreamChunk({ streamId: "test-stream", chunk: "Line 1\n" }));
      store.dispatch(appendStreamChunk({ streamId: "test-stream", chunk: "Line 2\n" }));
      store.dispatch(appendStreamChunk({ streamId: "test-stream", chunk: "Special: !@#$%\n" }));
  ...
  describe("completeStream", () => {
    beforeEach(() => {
      store.dispatch(startStream({ streamId: "test-stream" }));
      store.dispatch(appendStreamChunk({ streamId: "test-stream", chunk: "Complete content" }));
    });
  ...
  describe("clearStream", () => {
    beforeEach(() => {
      store.dispatch(startStream({ streamId: "stream-1" }));
      store.dispatch(startStream({ streamId: "stream-2" }));
      store.dispatch(appendStreamChunk({ streamId: "stream-1", chunk: "Content 1" }));
    });
  ...
  describe("setStreamError", () => {
    ...
    it("should set error and stop streaming", () => {
      store.dispatch(setStreamError({ streamId: "test-stream", error: "Connection lost" }));
    ...
    it("should preserve content when error occurs", () => {
      store.dispatch(appendStreamChunk({ streamId: "test-stream", chunk: "Partial content" }));
      store.dispatch(setStreamError({ streamId: "test-stream", error: "Error occurred" }));
  ...
  describe("selectors", () => {
    beforeEach(() => {
      store.dispatch(startStream({ streamId: "test-stream" }));
      store.dispatch(appendStreamChunk({ streamId: "test-stream", chunk: "Test content" }));
    });
    ...
    it("selectStreamError should return error message", () => {
      store.dispatch(setStreamError({ streamId: "test-stream", error: "Test error" }));
  ...
  describe("complete streaming workflow", () => {
    it("should handle typical terminal output streaming", () => {
      ...
      store.dispatch(appendStreamChunk({ streamId, chunk: "Installing packages...\n" }));
    ...
    it("should handle agent thought streaming", () => {
      ...
      store.dispatch(appendStreamChunk({ streamId, chunk: "codebase structure" }));
      store.dispatch(completeStream({ streamId }));
    ...
    it("should handle stream error during streaming", () => {
      ...
      store.dispatch(startStream({ streamId }));
      store.dispatch(appendStreamChunk({ streamId, chunk: "Starting process..." }));
