      ...
      <div className="max-w-7xl mx-auto">
        <div className={`text-center mb-16 ${isVisible ? "stagger-item delay-0" : "opacity-0"}`}>
          ...
          <p className="text-lg text-foreground-secondary max-w-2xl mx-auto">
            Enterprise-grade features that eliminate 80% of repetitive coding and let you focus on what matters
          </p>
        </div>
          ...
          {FEATURES.map((feature, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <Icon className="w-8 h-8 text-white floating-icon" style={{ animationDelay: `${index * 0.3}s` }} />
                </div>
