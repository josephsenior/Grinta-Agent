...
export function GitProviderDropdown({
  ...
  type GetItemPropsFn = <Options>(
    options: UseComboboxGetItemPropsOptions<Provider> & Options,
  ...
  const renderItem = (
    ...
    currentGetItemProps: GetItemPropsFn,
  ) => (
    <DropdownItem
      key={item}
      item={item}
        ...
        <input
          ...
          {...getInputProps({
            ...
            className: cn(
              ...
              "bg-grey-500 text-content-2 placeholder:text-foreground-secondary placeholder:italic",
