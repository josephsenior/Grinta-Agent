...
export function ConfigureModal({
  ...
  const validateMutation = useValidateIntegration(platform, {
    ...
    onError: (error) => {
      // Narrow unknown error to AxiosError before accessing response
      ...
      <ModalBody className="items-start border border-border w-96">
              ...
              components={{
                ...
                a: (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-violet-500 hover:text-brand-400 underline transition-colors duration-200"
                  >
                    Check the document for more information
                  </a>
                ),
        ...
        <div className="w-full flex flex-col gap-4 mt-1">
          <div>
            ...
            {workspaceError && (
              <p className="text-error-500 text-sm mt-2">{workspaceError}</p>
            )}
          </div>
          ...
          {showConfigurationFields && (
            <>
              ...
              <div>
                ...
                />
                {apiKeyError && (
                  <p className="text-error-500 text-sm mt-2">{apiKeyError}</p>
                )}
              </div>
              <div className="mt-4">
                <SettingsSwitch
