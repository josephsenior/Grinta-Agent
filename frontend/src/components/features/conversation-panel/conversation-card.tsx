                  ...
                  <>
                    <div className="flex justify-between items-center pb-2">
                      ...
                      <span className="font-semibold text-foreground">
                        <ClientNumber value={metrics.usage.prompt_tokens} />
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 pl-4 text-sm">
                      ...
                      <span className="text-right text-foreground">
                        <ClientNumber value={metrics.usage.cache_read_tokens} />
                      </span>
                      <span className="text-foreground-secondary">
                      ...
                      <span className="text-right text-foreground">
                        <ClientNumber
                          value={metrics.usage.cache_write_tokens}
                        />
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between items-center border-b border-border pb-2">
                      ...
                      <span className="font-semibold text-foreground">
                        <ClientNumber value={metrics.usage.completion_tokens} />
                      </span>
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex justify-end">
                        <span className="text-xs text-foreground-secondary">
                          <ClientNumber value={metrics.usage.per_turn_token} />{" "}
                          /{" "}
                          <ClientNumber value={metrics.usage.context_window} />{" "}
                          (
                          {(
