...
function useConversationCardController({
  ...
  const hasContextMenu = React.useMemo(
    () => hasContextMenuOptions({ onDelete, onChangeTitle, showOptions }),
...
function hasContextMenuOptions({
  ...
  return Boolean(onDelete || onChangeTitle || showOptions);
}
  ...
  return (
    <>
      ...
      <SystemMessageModal
        ...
        systemMessage={systemMessage ? (systemMessage as any)?.args : null}
      />
