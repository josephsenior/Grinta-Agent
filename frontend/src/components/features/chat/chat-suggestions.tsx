...
export function ChatSuggestions({ onSuggestionsClick }: ChatSuggestionsProps) {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center p-4 bg-background-secondary border border-border rounded-xl w-full">
        <BuildIt width={45} height={54} />
        <span className="font-semibold text-[20px] leading-6 -tracking-[0.01em] gap-1 text-foreground">
