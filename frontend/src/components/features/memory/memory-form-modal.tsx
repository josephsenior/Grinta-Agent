      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-border">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-semibold text-foreground">
                {memory
                  ? t("MEMORY$MODAL_EDIT_TITLE")
                  : t("MEMORY$MODAL_ADD_TITLE")}
              </h2>
            </div>
            <button
              type="button"
              ...
              <div>
                ...
                >
                  <option value="technical">
                    {t("MEMORY$CATEGORY_TECHNICAL")}
                  </option>
                  <option value="preference">
                    {t("MEMORY$CATEGORY_PREFERENCE")}
                  </option>
                  <option value="project">
                    {t("MEMORY$CATEGORY_PROJECT")}
                  </option>
                  <option value="fact">{t("MEMORY$CATEGORY_FACT")}</option>
                  <option value="custom">{t("MEMORY$CATEGORY_CUSTOM")}</option>
                </select>
              </div>
              <div>
                <label
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-background-primary border border-border rounded-md text-foreground focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent"
                >
                  <option value="low">{t("MEMORY$IMPORTANCE_LOW")}</option>
                  <option value="medium">
                    {t("MEMORY$IMPORTANCE_MEDIUM")}
                  </option>
                  <option value="high">{t("MEMORY$IMPORTANCE_HIGH")}</option>
                </select>
              </div>
            </div>
          ...
          <div className="flex justify-end gap-3 p-6 border-t border-border">
            ...
            >
              {memory ? t("MEMORY$BUTTON_UPDATE") : t("MEMORY$BUTTON_SAVE")}
            </BrandButton>
          </div>
        </div>
      </div>
