...
describe("StreamingTerminal", () => {
  ...
  it("should display streaming content", () => {
    ...
    store.dispatch(appendStreamChunk({ streamId: "test-stream", chunk: "$ echo 'Hello'\n" }));
  ...
  it("should show streaming indicator when streaming", () => {
    store.dispatch(startStream({ streamId: "test-stream" }));
    store.dispatch(appendStreamChunk({ streamId: "test-stream", chunk: "Loading...\n" }));
  ...
  it("should not show cursor when stream is complete", () => {
    store.dispatch(startStream({ streamId: "test-stream" }));
    store.dispatch(appendStreamChunk({ streamId: "test-stream", chunk: "Done\n" }));
  ...
  it("should display command execution example", () => {
    ...
    store.dispatch(appendStreamChunk({ streamId: "cmd-stream", chunk: "$ npm test\n" }));
    store.dispatch(appendStreamChunk({ streamId: "cmd-stream", chunk: "Running tests...\n" }));
    store.dispatch(appendStreamChunk({ streamId: "cmd-stream", chunk: "✓ All tests passed\n" }));
