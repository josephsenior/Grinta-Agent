        ...
        <div className="relative">
          <input
            ...
            placeholder={t(I18nKey.COMMON$SEARCH_REPOSITORIES, {
              defaultValue: `${t(I18nKey.COMMON$SEARCH_REPOSITORIES)}...`,
            })}
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            className={cn(
              "bg-background-glass backdrop-blur-xl border border-border-glass w-full rounded-xl p-3 placeholder:italic placeholder:text-text-foreground-secondary text-text-primary transition-all duration-200 focus:border-primary-500/50 focus:bg-primary-500/5 focus:shadow-lg focus:shadow-primary-500/10",
              "disabled:bg-background-surface disabled:border-border-subtle disabled:cursor-not-allowed disabled:opacity-50 h-10 box-shadow-none outline-none",
