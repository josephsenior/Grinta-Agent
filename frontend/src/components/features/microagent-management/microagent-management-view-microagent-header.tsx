...
export function MicroagentManagementViewMicroagentHeader() {
  ...
  const { selectedMicroagentItem, selectedRepository } = useSelector(
      ...
      <div className="flex items-center justify-end gap-2">
        <a href={microagentUrl} target="_blank" rel="noopener noreferrer">
          <BrandButton
            ...
            className="py-1 px-2"
          >
            {t(I18nKey.COMMON$EDIT_IN, {
              defaultValue: `${t(I18nKey.COMMON$EDIT_IN)} ${getProviderName(selectedRepository.git_provider)}`,
            })}
          </BrandButton>
        </a>
        <BrandButton
