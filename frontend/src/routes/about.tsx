...
export default function About(): React.ReactElement {
  ...
  return (
    <>
      <SEO
        title="About"
        description="Learn about Forge, the AI-powered development platform that helps you build software faster with advanced agents and intelligent code generation."
        keywords="about, AI development, software development, Forge platform"
      />
