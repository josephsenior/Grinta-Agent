...
export default function HelpPage() {
  ...
  return (
    <>
      <SEO
        title="Help & Support"
        description="Get help with Forge. Find documentation, tutorials, keyboard shortcuts, and support resources."
        keywords="help, support, documentation, tutorials, FAQ, Forge help"
      />
