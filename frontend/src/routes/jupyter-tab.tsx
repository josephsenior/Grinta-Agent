...
// Lazy load heavy Jupyter component for better performance
const JupyterEditor = React.lazy(() =>
  import("#/components/features/jupyter/jupyter").then((m) => ({
    default: m.JupyterEditor,
  })),
);
