...
4. **Test**: run `pytest` for backend, `pnpm test` for frontend
...
| `backend/controller/services/` | Service classes composing the controller (see below) |
...
| `frontend/src/hooks/` | React hooks (WebSocket, state, auth) |
| `frontend/src/components/` | UI components |
| `frontend/src/state/` | Redux slices (12 slices) |
...
Open a [Discussion](https://github.com/your-org/forge/discussions) or file an issue.
